...
import { HomeScene } from "@/components/pixel-scenes/HomeScene";
...
export default async function HomePage({
  ...
  return (
    <main className="relative isolate min-h-[70vh] overflow-hidden">
      <HomeScene />
      <div className="mx-auto max-w-md p-8">
        <div className="rounded-lg border border-amber-300 bg-white/95 p-6 shadow-lg backdrop-blur-sm">
